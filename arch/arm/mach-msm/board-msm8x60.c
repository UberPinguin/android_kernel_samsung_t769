...
#if defined(CONFIG_KOR_MODEL_SHV_E120L)  || defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined(CONFIG_USA_MODEL_SGH_I577)
...
unsigned int get_hw_rev(void)
{
 ...
 || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined (CONFIG_USA_MODEL_SGH_T769) || defined (CONFIG_USA_MODEL_SGH_I577)
		for(i = 0; i < 3; i++)
		{
...
#elif defined (CONFIG_USA_MODEL_SGH_I727)|| defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined(CONFIG_USA_MODEL_SGH_I577)
		sprintf(str_rev, "HW_REV_%d", 3);
...
static void gsbi7_qup_i2c_gpio_config(int adap_id, int config_type)
{
 ...
 || defined(CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
#define MSM_FB_SIZE roundup(MSM_FB_PRIM_BUF_SIZE + 0xFD2000 + MSM_FB_WRITEBACK_SIZE + MSM_FB_DSUB_PMEM_ADDER, 4096) 
	...
	|| defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_CAN_MODEL_SGH_I757M) || defined (CONFIG_JPN_MODEL_SC_03D)
...
#define MSM_PMEM_AUDIO_SIZE        0x279000
#endif
#if defined (CONFIG_KERNEL_BASE_ADDR_0X48000000)
...
static void __init msm8x60_allocate_memory_regions(void)
{
...
#ifdef CONFIG_ANDROID_RAM_CONSOLE
#ifndef CONFIG_KERNEL_BASE_ADDR_0X48000000      
	int ret;
	...
	if (size) {
		...
		android_pmem_adsp_pdata.size = size;
 		pr_info("allocating %lu bytes at %lx physical) for adsp "
...
int get_mhl_int_irq(void)
{
	...
	if(hw_rev == 1)
		return PM8058_GPIO_IRQ(PM8058_IRQ_BASE, PMIC_GPIO_MHL_INT_9);
                ...
                return PM8058_GPIO_IRQ(PM8058_IRQ_BASE, PMIC_GPIO_MHL_INT_31);
#elif defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_KOR_MODEL_SHV_E160L)
        return PM8058_GPIO_IRQ(PM8058_IRQ_BASE, PMIC_GPIO_MHL_INT_31);
#else
       	return PM8058_GPIO_IRQ(PM8058_IRQ_BASE, PMIC_GPIO_MHL_INT_9);
#endif
...
#elif defined(CONFIG_CAN_MODEL_SGH_I757M)
			// SPK
			[0] = {
				.in1_gain = 2,
				.in2_gain = 2,
...
#if defined (CONFIG_USA_MODEL_SGH_T989) || defined(CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
#elif CONFIG_CAN_MODEL_SGH_I757M
    RPM_VREG_INIT_LDO(PM8901_L6,  0, 1, 0, 3000000, 3000000, LDO300HMIN, 0),
#else
...
#define MXT540E_ACTVSYNCSPERX_BATT		32
...
static u8 t9_config_540e[] = {TOUCH_MULTITOUCHSCREEN_T9,
		...
		10, 10, 1, 47, MXT540E_MAX_MT_FINGERS, 20, 40, 20, 31, 3,
...
static u8 t48_config_540e[] = {PROCG_NOISESUPPRESSION_T48,
		...
		0, 0, 0, 6, 6, 0, 0, 48, 4, 64,
		10, 0, 15, 6, 0, 36, 0, 0, 0, 0,
...
static u8 t48_config_chrg_540e[] = {PROCG_NOISESUPPRESSION_T48,
		...
		MXT540E_MAX_MT_FINGERS, 5, 20, 253, 0, 3, 3, 160, 55, 136,
...
static int wacom_settle_down_befor_poweron(void)
{
	int ret;
	int rc;
...
*/
 ...
 || defined(CONFIG_USA_MODEL_SGH_I757)  || defined(CONFIG_CAN_MODEL_SGH_I757M) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
#if defined(CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_CAN_MODEL_SGH_I757M)
...
static int __init tkey_device_init(void)
{
 ...
 || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_CAN_MODEL_SGH_I757M)|| defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
#elif defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined(CONFIG_USA_MODEL_SGH_I717)
int tkey_vdd_enable(int onoff)
{
	struct regulator *lvs2;	
	struct regulator *l12;	
...
#if defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_T989) || defined(CONFIG_USA_MODEL_SGH_I757)|| defined (CONFIG_CAN_MODEL_SGH_I757M)\
	 || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
#elif defined(CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757)|| defined (CONFIG_CAN_MODEL_SGH_I757M) || defined(CONFIG_USA_MODEL_SGH_I577)
    if(true)
#endif
	{
		l12 = regulator_get(NULL, "8058_l12");
...
#elif defined(CONFIG_KOR_MODEL_SHV_E110S) || defined(CONFIG_JPN_MODEL_SC_03D) || defined(CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K)
...
#if defined(CONFIG_KOR_MODEL_SHV_E110S) || defined(CONFIG_KOR_MODEL_SHV_E120S)||defined(CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_JPN_MODEL_SC_03D) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined(CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_T769)
...
static void taos_power_on(void)
{
	...
	if(vsensor_3p_proximity == NULL) {
		vsensor_3p_proximity = regulator_get(&rpm_vreg_device[RPM_VREG_ID_PM8901_L6].dev, "8901_l6");
...
#if defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_CAN_MODEL_SGH_I757M)
	msm_tlmm_set_spkr_pull(CODEC_SPKR_SCK_PULL, GPIO_CFG_PULL_DOWN);
	msm_tlmm_set_spkr_pull(CODEC_SPKR_WS_PULL, GPIO_CFG_PULL_DOWN);
#endif
}
#endif
...
#if defined (CONFIG_JPN_MODEL_SC_03D) || defined (CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_CAN_MODEL_SGH_I757M)
#if defined (CONFIG_JPN_MODEL_SC_03D)
...
static uint32_t I757_nc_port_config[] = {
	 GPIO_CFG(GPIO_77, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};
#endif
...
#elif defined (CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_CAN_MODEL_SGH_I757M)
	config_gpio_table(I757_nc_port_config, ARRAY_SIZE(I757_nc_port_config));
	printk("[SGH-I757] %s: Initialize NC port to IN/PD\n", __func__);
...
#ifdef CONFIG_VIDEO_MHL_V2
static struct platform_device *I757_devices[] __initdata = {
	&mhl_i2c_gpio_device,
};
#endif	
...
#endif
#ifdef CONFIG_VIDEO_MHL_V2
	platform_add_devices(I757_devices, ARRAY_SIZE(I757_devices));
#endif
